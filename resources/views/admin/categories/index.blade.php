...
@section('links')
    ...
    <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Categories</span>
@endsection
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($category->active == '1')
                                            <label class="btn btn-info-gradient btn-sm">Activated</label>
                                        @elseif($category->active == '0')
                                            <label class="btn btn-danger-gradient btn-sm">Deactivated</label>
                                        @endif
                                    </td>
                                    <td>
                                        <a class="btn btn-warning btn-sm" href="{{ route('categories.edit', $category->id) }}" title="Edit">
